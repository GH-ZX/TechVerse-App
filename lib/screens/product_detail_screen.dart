...
class _ProductDetailScreenState extends State<ProductDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final relatedProducts =
        productProvider
            .getProductsByCategory(widget.product.category)
                              ...
                              return Builder(
                                builder: (BuildContext context) {
                                  return Container(
                                    ...
                                    child: Image.asset(
                                      productProvider.getImagePath(images),
                                      fit: BoxFit.contain,
                                    ),
                                  );
                                },
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TabBar(
                          ...
                          tabs: [
                            Tab(
                              text: localizations.translate('product_details'),
                            ),
                            Tab(
                              text: localizations.translate('specifications'),
                            ),
